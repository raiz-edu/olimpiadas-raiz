...
// ─── Helpers (replicados de analytics/page.tsx; triviais, evita refactor) ──────
...
/** Linha de distribuição com label, contagem, % e barra proporcional. */
function BarRow({
  label,
  value,
  total,
...
export default async function BancoQuestoesAnalyticsPage({
  searchParams,
}: {
  ...
  // era truncado em 1000 e todas as agregações saíam capadas. Paginar até esgotar.
  const PAGE = 1000;
  ...
  // ─── Opções de filtro a partir do acervo (selects dinâmicos) ────────────────
  ...
  // B — Cobertura de resolução (vídeo / texto)
