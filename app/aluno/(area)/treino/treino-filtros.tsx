...
const itemCls = "flex flex-col gap-1 sm:flex-1 sm:min-w-[80px]";
...
export function TreinoFiltros({
  ...
  return (
    <form method="GET" className="mb-6 rounded-xl border border-border bg-card p-4 space-y-3">
      {/* Linha de filtros — distribuída em largura total */}
      <div className="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:items-end">
        ...
        <div className={itemCls}>
          <span className={labelCls}>Tópico</span>
          <select
            name="topico"
            value={topicoSel}
        ...
        {topicoSel && (
          <div className={`col-span-2 sm:col-span-1 ${itemCls}`}>
            <span className={labelCls}>Subtópico</span>
            <select
              name="subtopico"
              value={subtopico}
