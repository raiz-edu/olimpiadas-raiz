...
select item, ok from (
  ...
  union all select 'solucao.blocos (055)',              exists (select 1 from information_schema.columns where table_schema = 'public' and table_name = 'solucao'         and column_name = 'blocos')
  union all select 'resposta_aluno.contexto (055)',     exists (select 1 from information_schema.columns where table_schema = 'public' and table_name = 'resposta_aluno'  and column_name = 'contexto')
  union all select 'resposta_aluno.aula_id (055)',      exists (select 1 from information_schema.columns where table_schema = 'public' and table_name = 'resposta_aluno'  and column_name = 'aula_id')
  union all select 'meta_marca.criado_em (055)',        exists (select 1 from information_schema.columns where table_schema = 'public' and table_name = 'meta_marca'      and column_name = 'criado_em')
